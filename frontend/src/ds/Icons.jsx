...
const ICON_PATHS = {
  ...
  "zoom-in": [["circle","11","11","8"],["line","21","21","16.65","16.65"],["line","11","8","11","14"],["line","8","11","14","11"]],
  "zoom-out": [["circle","11","11","8"],["line","21","21","16.65","16.65"],["line","8","11","14","11"]],
  ...
  trash: [["path","M3 6h18"],["path","M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"],["path","M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"],["line","10","11","10","17"],["line","14","11","14","17"]],
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor"
      ...
      {nodes.map((n, i) => {
        ...
        if (n[0] === "line") return <line key={i} x1={n[1]} y1={n[2]} x2={n[3]} y2={n[4]} />;
        return null;
      })}
    </svg>
  );
